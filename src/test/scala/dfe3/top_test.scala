...
val real = Source.fromFile("/scratch/cs250-aab/src/test/scala/dfe3/testing/filter_real_15.txt").getLines.toArray.map(x => x.toDouble)
val imag = Source.fromFile("/scratch/cs250-aab/src/test/scala/dfe3/testing/filter_imag_15.txt").getLines.toArray.map(x => x.toDouble)
val test_real = Source.fromFile("/scratch/cs250-aab/src/test/scala/dfe3/testing/test_real_15.txt").getLines.toArray.map(x => x.toDouble)
val test_imag = Source.fromFile("/scratch/cs250-aab/src/test/scala/dfe3/testing/test_imag_15.txt").getLines.toArray.map(x => x.toDouble)
