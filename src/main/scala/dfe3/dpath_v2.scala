...
class dpathtotalIo[T <: Data:RealBits](gen: T) extends Bundle {
  val signal_in = Input(DspComplex(FixedPoint(16.W, 12.BP) ))
  val signal_out = Output(DspComplex(FixedPoint(16.W, 12.BP) ))
  val coeff_in = Input(DspComplex(FixedPoint(22.W, 12.BP) ))
  val coeff_out = Output(DspComplex(FixedPoint(22.W, 12.BP) ))
